...
public export
Num UnixelFraction where
  (+) = addUnixelFraction
  (*) = mulUnixelFraction
  fromInteger n = mkUnixelFraction (intToBoxInt n) 1

public export
Neg UnixelFraction where
  negate = negateUnixelFraction
  (-) = subUnixelFraction

public export
Fractional UnixelFraction where
  (/) = divUnixelFraction
